...
//commenter par aya
    ...
    //public List<Role> findRolesByUtilisateurId(Long utilisateurId) {
     //   return List.of();
  //  }
//remplacer par aya pour que le rôle principal sera ADMIN/MEDECIN/SECRETAIRE comme dans utilisateur.role_id
    //car uth fait : roleRepo.findRolesByUtilisateurId(u.getId())
//Mais ton RoleRepositoryImpl retourne List.of() → rôle = null.
@Override
public List<Role> findRolesByUtilisateurId(Long utilisateurId) {
