...
public class AntecedentServiceImpl implements AntecedentService {
    ...
    public Antecedents getById(Long id) {
        if (id == null || id <= 0) throw new ServiceException("id antecedent obligatoire");
        try {
            Antecedents a = repo.findById(id);
            if (a == null) throw new ServiceException("Antecedent introuvable (id=" + id + ")");
            return a;
    ...
    public void update(Antecedents a) {
        ...
        try {
            ...
            if (existing == null) throw new ServiceException("Antecedent introuvable (id=" + a.getId() + ")");
            repo.update(a);
        } catch (ServiceException se) {
            throw se;
        } catch (DaoException e) {
    ...
    public List<Antecedents> getByPatientId(Long patientId) {
        if (patientId == null || patientId <= 0) throw new ServiceException("patientId obligatoire");
        try {
    ...
    private void validateCreate(Antecedents a) {
        if (a == null) throw new ServiceException("Antecedent null");
        if (a.getId() != null) throw new ServiceException("Création: id doit être null");
        validateCommon(a);
    }

    private void validateUpdate(Antecedents a) {
        if (a == null) throw new ServiceException("Antecedent null");
        if (a.getId() == null || a.getId() <= 0) throw new ServiceException("id antecedent obligatoire");
        validateCommon(a);
    }

    private void validateCommon(Antecedents a) {
        if (a.getNom() == null || a.getNom().isBlank()) {
            throw new ServiceException("nom antecedent obligatoire");
        }
    }
}
