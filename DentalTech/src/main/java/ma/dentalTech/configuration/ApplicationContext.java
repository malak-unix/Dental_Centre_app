...
// Imports pour ton module Profile
...
public final class ApplicationContext {
    ...
    static {
        ...
        try {
            ...
            RdvService rdvService = newInstance(props, "rdv.service", RdvService.class,
                    new Class<?>[]{RdvRepository.class}, new Object[]{rdvRepo});
            ...
            ListeAttenteService listeService = newInstance(props, "listeAttente.service", ListeAttenteService.class,
                    new Class<?>[]{ListeAttenteRepository.class}, new Object[]{listeRepo});
            ...
            PlageHoraireService plageService = newInstance(props, "plageHoraire.service", PlageHoraireService.class,
                    new Class<?>[]{PlageHoraireRepository.class}, new Object[]{plageRepo});
            ...
            // ==========================================
            // --- NOUVEAU : AUTH & PROFILE (TA PARTIE) ---
            // ==========================================
            currentBean = "roleRepo";
            RoleRepository roleRepo = newInstance(props, "roleRepo", RoleRepository.class);
            put(RoleRepository.class, roleRepo, "roleRepo");

            currentBean = "medecinRepo";
            MedecinRepository medecinRepo = newInstance(props, "medecinRepo", MedecinRepository.class);
            put(MedecinRepository.class, medecinRepo, "medecinRepo");

            currentBean = "secretaireRepo";
            SecretaireRepository secretaireRepo = newInstance(props, "secretaireRepo", SecretaireRepository.class);
            put(SecretaireRepository.class, secretaireRepo, "secretaireRepo");

            currentBean = "adminRepo";
            AdminRepository adminRepo = newInstance(props, "adminRepo", AdminRepository.class);
            put(AdminRepository.class, adminRepo, "adminRepo");

            currentBean = "staffRepo";
            StaffRepository staffRepo = newInstance(props, "staffRepo", StaffRepository.class);
            put(StaffRepository.class, staffRepo, "staffRepo");

            currentBean = "profileService";
            ProfileService profileService = newInstance(props, "profileService", ProfileService.class,
                    new Class<?>[]{
                            UtilisateurRepository.class, StaffRepository.class, MedecinRepository.class,
                            SecretaireRepository.class, AdminRepository.class, RoleRepository.class,
                            ProfileValidator.class, Object.class, Object.class
                    },
                    new Object[]{
                            utilisateurRepo, staffRepo, medecinRepo,
                            secretaireRepo, adminRepo, roleRepo,
                            new ProfileValidatorImpl(), null, null
                    });
            put(ProfileService.class, profileService, "profileService");

            // ==========================================
            // DASHBOARD SERVICE (Suite)
            // ==========================================
            Object consultationRepoObj = createOptionalRepo(props, "consultationRepo", ma.dentalTech.repository.modules.dossierMedical.api.ConsultationRepository.class, "consultationRepo");
            Object acteRepoObj = createOptionalRepo(props, "acteRepo", ma.dentalTech.repository.modules.dossierMedical.api.ActeRepository.class, "acteRepo");
            Object dossierMedicalRepoObj = createOptionalRepo(props, "dossierMedicalRepo", ma.dentalTech.repository.modules.dossierMedical.api.DossierMedicalRepository.class, "dossierMedicalRepo");

            boolean canCreateDashboard = consultationRepoObj != null && acteRepoObj != null && dossierMedicalRepoObj != null && caisseService != null && rdvRepo != null && listeRepo != null && notificationRepo != null && utilisateurRepo != null && patientRepo != null && factureRepo != null && chargesRepo != null;

            if (canCreateDashboard) {
                currentBean = "dashboardService";
                DashboardService dashboardService = newInstance(props, "dashboardService", DashboardService.class,
                        new Class<?>[]{ CaisseDashboardService.class, RdvRepository.class, ListeAttenteRepository.class, NotificationRepository.class, ma.dentalTech.repository.modules.dossierMedical.api.ConsultationRepository.class, ma.dentalTech.repository.modules.dossierMedical.api.ActeRepository.class, UtilisateurRepository.class, PatientRepository.class, ma.dentalTech.repository.modules.dossierMedical.api.DossierMedicalRepository.class, FactureRepository.class, ChargesRepository.class },
                        new Object[]{ caisseService, rdvRepo, listeRepo, notificationRepo, consultationRepoObj, acteRepoObj, utilisateurRepo, patientRepo, dossierMedicalRepoObj, factureRepo, chargesRepo });
    ...
    public static Object getBean(String name) { return contextByName.get(name); }
    public static boolean hasBean(String name) { return contextByName.containsKey(name); }
    @SuppressWarnings("unchecked")
    public static <T> T getBean(Class<T> clazz) { return (T) context.get(clazz); }
    ...
    private static <T> T newInstance(Properties props, String key, Class<T> expectedType, Class<?>[] ctorTypes, Object[] ctorArgs) throws Exception {
        String className = props.getProperty(key);
        if (className == null || className.isBlank()) throw new IllegalStateException("Bean '" + key + "' introuvable");
    ...
    private static void createOptional(Properties props, String key, Class<?> depType, Object depInstance) {
        ...
        } catch (Exception e) { throw new RuntimeException("Erreur création bean '" + key + "'", e); }
    }
    ...
    static {
        try (InputStream in = ApplicationContext.class.getResourceAsStream("/application.properties")) {
            if (in != null) configProps.load(in);
        } catch (Exception e) {}
    }
    public static String getProperty(String key, String defaultValue) { return configProps.getProperty(key, defaultValue); }
