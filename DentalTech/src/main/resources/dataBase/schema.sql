...
CREATE TABLE consultation (
  ...
  statut ENUM('PLANIFIE','TERMINE','ANNULE',"EN_COURS") DEFAULT 'PLANIFIE',
...
-- =========================================================
--  DOCUMENT MEDICAL (pièces jointes du dossier)
-- =========================================================
...
CREATE INDEX idx_doc_dossier ON document_medical(dossier_id);
CREATE INDEX idx_doc_consultation ON document_medical(consultation_id);
